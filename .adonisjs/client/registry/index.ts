...
const routes = {
  ...
  'local_business_prospects.list_local_business_prospects': {
    ...
    tokens: [{"old":"/local-businesses","type":0,"val":"local-businesses","end":""}],
    types: placeholder as Registry['local_business_prospects.list_local_business_prospects']['types'],
  },
  'local_business_prospects.list_weekly_local_business_prospects': {
    methods: ["GET","HEAD"],
    pattern: '/local-businesses/weekly',
    tokens: [{"old":"/local-businesses/weekly","type":0,"val":"local-businesses","end":""},{"old":"/local-businesses/weekly","type":0,"val":"weekly","end":""}],
    types: placeholder as Registry['local_business_prospects.list_weekly_local_business_prospects']['types'],
  },
  'local_business_prospects.search_osm_by_city': {
    methods: ["POST"],
    pattern: '/local-businesses/search-osm',
    tokens: [{"old":"/local-businesses/search-osm","type":0,"val":"local-businesses","end":""},{"old":"/local-businesses/search-osm","type":0,"val":"search-osm","end":""}],
    types: placeholder as Registry['local_business_prospects.search_osm_by_city']['types'],
  },
  'local_business_prospects.bulk_import_from_osm': {
    methods: ["POST"],
    pattern: '/local-businesses/bulk-import',
    tokens: [{"old":"/local-businesses/bulk-import","type":0,"val":"local-businesses","end":""},{"old":"/local-businesses/bulk-import","type":0,"val":"bulk-import","end":""}],
    types: placeholder as Registry['local_business_prospects.bulk_import_from_osm']['types'],
  },
  'local_business_prospects.bulk_local_business_prospect_action': {
    methods: ["POST"],
    pattern: '/local-businesses/bulk-actions',
    tokens: [{"old":"/local-businesses/bulk-actions","type":0,"val":"local-businesses","end":""},{"old":"/local-businesses/bulk-actions","type":0,"val":"bulk-actions","end":""}],
    types: placeholder as Registry['local_business_prospects.bulk_local_business_prospect_action']['types'],
  },
  'local_business_prospects.get_local_business_prospect': {
    methods: ["GET","HEAD"],
    pattern: '/local-businesses/:id',
    tokens: [{"old":"/local-businesses/:id","type":0,"val":"local-businesses","end":""},{"old":"/local-businesses/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['local_business_prospects.get_local_business_prospect']['types'],
  },
  'local_business_prospects.create_local_business_prospect': {
    methods: ["POST"],
    pattern: '/local-businesses',
    tokens: [{"old":"/local-businesses","type":0,"val":"local-businesses","end":""}],
    types: placeholder as Registry['local_business_prospects.create_local_business_prospect']['types'],
  },
  'local_business_prospects.update_local_business_prospect': {
    methods: ["PATCH"],
    pattern: '/local-businesses/:id',
    tokens: [{"old":"/local-businesses/:id","type":0,"val":"local-businesses","end":""},{"old":"/local-businesses/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['local_business_prospects.update_local_business_prospect']['types'],
  },
  'local_business_prospects.enrich_local_business_prospect': {
    methods: ["POST"],
    pattern: '/local-businesses/:id/enrich',
    tokens: [{"old":"/local-businesses/:id/enrich","type":0,"val":"local-businesses","end":""},{"old":"/local-businesses/:id/enrich","type":1,"val":"id","end":""},{"old":"/local-businesses/:id/enrich","type":0,"val":"enrich","end":""}],
    types: placeholder as Registry['local_business_prospects.enrich_local_business_prospect']['types'],
  },
  'local_business_prospects.delete_local_business_prospect': {
    methods: ["DELETE"],
    pattern: '/local-businesses/:id',
    tokens: [{"old":"/local-businesses/:id","type":0,"val":"local-businesses","end":""},{"old":"/local-businesses/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['local_business_prospects.delete_local_business_prospect']['types'],
  },
